...
def send_welcome(message):
	try:
		...
		/track
		Obtiene informacion de Envios Internacionales.
		""")
	except Exception,e:
		print e
...
def track(m): #Obtiene informacion de envios a traves de 17track.net
	try:
		cid = m.chat.id
		ID = str(m.text)
		ID = ID[6:]#Desde el caracter 6 se toma el codigo de envio
		...
		#Ver la forma de ordenar la data para enviar a traves de Telegram
